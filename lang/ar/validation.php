...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'subjects_id' => 'المقرر / المادة',
        'code_subject' => 'كود الماده',
        'departments_id' => 'القسم / الشعبة',
        'department_id' => 'القسم / الشعبة',
        'term' => 'الفصل الدراسي',
        'type_subject' => 'نوع المقرر',
        'degree_group1' => 'درجة الفرقة الاولي',
        'degree_group2' => 'درجة الفرقة الثانية',
        'degree_group3' => 'درجة الفرقة الثالثة',
        'degree_group4' => 'درجة الفرقة الرابعة',
        'file' => 'الملف',
        'yearsemester_id' => 'الفصل الدراسي',
        'site_no' => 'رقم جلوس الطالب',
        'code' => 'كود الطالب',
        'subjects' => 'المقرر',
        'students_id' => 'الطالب',
        'degree' => 'الدرجة',
        'degree.*' => 'الدرجة',
        'studystatuses_id' => 'حالة الطالب',
        'type_std' => 'نوع حالة الطالب',
        'specialize_id' => 'التخصص',
        'training' => 'التدريب الصيفي',
        'military' => 'التربية العسكرية',
