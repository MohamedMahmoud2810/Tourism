            ...
            <div class="flex flex-row justify-center md:justify-start mb-2 md:mb-0">
                <div class="relative">
                    <select wire:model.lazy="setUp.footer.perPage"
                            class="block appearance-none bg-slate-50 text-slate-900 py-2 px-2 pr-4 rounded leading-tight focus:outline-none focus:bg-white  text-blue  white:bg-slate-600 blue-800 dark:placeholder-slate-800">
